...
parser.add_argument('--checkpoint_path', default=r'E:\deep-learning-for-image-processing-master\pytorch_classification\Test5_resnet\resnet34-pre.pth', type=str,
